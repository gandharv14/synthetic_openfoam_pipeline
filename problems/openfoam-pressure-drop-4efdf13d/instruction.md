...
The case belongs to the `pressure_drop_calibration` workflow. Your job is to recalibrate the pressure-drop datum while preserving the physical inlet velocity and mesh.
