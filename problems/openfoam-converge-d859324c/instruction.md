...
The case belongs to the `solver_convergence_repair` workflow. Your job is to repair numerics and relaxation so the case converges without changing physical inputs.
