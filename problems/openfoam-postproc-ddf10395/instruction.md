...
The case belongs to the `postprocessing_instrumentation` workflow. Your job is to instrument the case with deterministic function objects while preserving the physics.
